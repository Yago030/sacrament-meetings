export const meetings = [
  {
    ...
    announcements: ["Ward temple night: January 10"]
  },
  {
    date: "2026-01-11",
    ...
    announcements: ["Fast offering collection after meetings"]
  },
  {
    date: "2026-01-18",
    meetingType: "regular",
    ...
    wardBusiness: [{ description: "Missionary farewell announcement" }],
    stakeBusiness: false,
    sacramentHymn: { number: 181, title: "Jesus of Nazareth, Savior and King" },
    speakers: [
      { name: "Brother Miller", topic: "Repentance", type: "speaker" },
      { name: "Sister Wilson", topic: "Forgiveness", type: "speaker" }
    ],
    closingHymn: { number: 136, title: "I Know That My Redeemer Lives" },
    closingPrayer: "Brother Moore",
    announcements: ["Youth activity Friday at 7 PM"]
  },
  {
    date: "2026-01-25",
    meetingType: "regular",
    ...
    speakers: [
      { name: "Brother Walker", topic: "Temple Worship", type: "speaker" },
  ...
  },
  {
    ...
    openingHymn: { number: 84, title: "Faith of Our Fathers" },
    ...
    announcements: ["Ward fast this weekend"]
  },
  {
    date: "2026-12-08",
    meetingType: "regular",
    ...
    speakers: [
      { name: "Sister Baker", topic: "Service", type: "speaker" },
      { name: "Brother Harris", topic: "Charity", type: "speaker" }
    ],
    closingHymn: { number: 219, title: "Because I Have Been Given Much" },
    closingPrayer: "Brother Nelson",
    announcements: ["Service project Saturday morning"]
  },
  {
    date: "2026-02-15",
    meetingType: "regular",
    ...
    openingHymn: { number: 124, title: "Be Still, My Soul" },
    openingPrayer: "Sister Morgan",
    wardBusiness: [{ description: "Missionary homecoming" }],
    stakeBusiness: false,
    sacramentHymn: { number: 175, title: "O God, the Eternal Father" },
    speakers: [{ name: "Brother Allen", topic: "Hope", type: "speaker" }],
    closingHymn: { number: 241, title: "Count Your Blessings" },
    closingPrayer: "Brother Perez",
    announcements: ["Ward conference next week"]
  },
  {
    date: "2026-08-22",
    meetingType: "regular",
    ...
    openingHymn: { number: 193, title: "I Stand All Amazed" },
    openingPrayer: "Brother Cooper",
    wardBusiness: [],
    stakeBusiness: true,
    sacramentHymn: { number: 183, title: "In Remembrance" },
    speakers: [{ name: "Stake President Johnson", topic: "Covenant Keeping", type: "speaker" }],
    closingHymn: { number: 88, title: "Great Is Thy Faithfulness" },
    closingPrayer: "Brother Reed",
    announcements: ["Stake youth conference registration"]
  },
  {
    date: "2026-07-01",
    meetingType: "testimony",
    ...
    announcements: ["Missionary preparation class Tuesday"]
  },
  {
    date: "2026-08-08",
    meetingType: "regular",
    ...
    openingHymn: { number: 300, title: "Families Can Be Together Forever" },
    openingPrayer: "Sister Cox",
    wardBusiness: [{ description: "New ministering assignments announced" }],
    stakeBusiness: false,
    sacramentHymn: { number: 190, title: "In Memory of the Crucified" },
    speakers: [
      { name: "Sister Nelson", topic: "The Eternal Family", type: "speaker" },
    ...
    announcements: ["Family history workshop next Saturday"]
  }
];
